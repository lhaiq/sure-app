...
INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('商务', '0');
INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('生活', '0');
INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('旅行', '0');


INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('9-12', '1');
INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('14-18', '1');
INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('18-21', '1');
INSERT INTO `sure`.`dictionary` (`content`, `type`) VALUES ('9-18', '1');


insert into city (id,name) values(1,'北京市');
insert into city (id,name) values(2,'天津市');
insert into city (id,name) values(3,'上海市');
insert into city (id,name) values(4,'重庆市');
insert into city (id,name) values(5,'河北省');
insert into city (id,name) values(6,'山西省');
insert into city (id,name) values(7,'台湾省');
insert into city (id,name) values(8,'辽宁省');
insert into city (id,name) values(9,'吉林省');
insert into city (id,name) values(10,'黑龙江省');
insert into city (id,name) values(11,'江苏省');
insert into city (id,name) values(12,'浙江省');
insert into city (id,name) values(13,'安徽省');
insert into city (id,name) values(14,'福建省');
insert into city (id,name) values(15,'江西省');
insert into city (id,name) values(16,'山东省');
insert into city (id,name) values(17,'河南省');
insert into city (id,name) values(18,'湖北省');
insert into city (id,name) values(19,'湖南省');
insert into city (id,name) values(20,'广东省');
insert into city (id,name) values(21,'甘肃省');
insert into city (id,name) values(22,'四川省');
insert into city (id,name) values(23,'贵州省');
insert into city (id,name) values(24,'海南省');
insert into city (id,name) values(25,'云南省');
insert into city (id,name) values(26,'青海省');
insert into city (id,name) values(27,'陕西省');
insert into city (id,name) values(28,'广西壮族自治区');
insert into city (id,name) values(29,'西藏自治区');
insert into city (id,name) values(30,'宁夏回族自治区');
insert into city (id,name) values(31,'新疆维吾尔自治区');
insert into city (id,name) values(32,'内蒙古自治区');
insert into city (id,name) values(33,'澳门特别行政区');
insert into city (id,name) values(34,'香港特别行政区');

-- 插入各个省的城市数据
-- 4个直辖市
insert into city values(400,'北京市',1);
insert into city values(401,'天津市',2);
insert into city values(402,'上海市',3);
insert into city values(403,'重庆市',4);
-- select * from city where provincialID=4
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- 5河北省 11个地级市
insert into city values(404,'石家庄市',5);
insert into city values(405,'唐山市',5);
insert into city values(406,'秦皇岛市',5);
insert into city values(407,'邯郸市',5);
insert into city values(408,'邢台市',5);
insert into city values(409,'保定市',5);
insert into city values(410,'张家口市',5);
insert into city values(411,'承德市',5);
insert into city values(412,'沧州市',5);
insert into city values(413,'廊坊市',5);
insert into city values(414,'衡水市',5);
-- select * from city where provincialID=5 order by cityID
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- 6山西省 11个城市
insert into city values(415,'太原市',6);
insert into city values(416,'大同市',6);
insert into city values(417,'阳泉市',6);
insert into city values(418,'长治市',6);
insert into city values(419,'晋城市',6);
insert into city values(420,'朔州市',6);
insert into city values(421,'晋中市',6);
insert into city values(422,'运城市',6);
insert into city values(423,'忻州市',6);
insert into city values(424,'临汾市',6);
insert into city values(425,'吕梁市',6);
-- select * from city where provincialID=6 order by cityID
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- 7台湾省(400湾本岛和澎湖共设7市、16县，其中台北市和高雄市为“院辖市”，直属“行政院”，其余属台湾省；市下设区，县下设市（县辖市）、镇、乡，合称区市镇乡。);
insert into city values(426,'台北市',7);
insert into city values(427,'高雄市',7);
insert into city values(428,'基隆市',7);
insert into city values(429,'台中市',7);
insert into city values(430,'台南市',7);
insert into city values(431,'新竹市',7);
insert into city values(432,'嘉义市',7);
insert into city values(433,'台北县',7);
...
INSERT INTO `conf` (`key`,`value`) VALUES ('invitation.price.09to12','200');
INSERT INTO `conf` (`key`,`value`) VALUES ('invitation.price.14to18','220');
INSERT INTO `conf` (`key`,`value`) VALUES ('invitation.price.18to21','230');
INSERT INTO `conf` (`key`,`value`) VALUES ('invitation.price.09to18','240');
INSERT INTO `conf` (`key`,`value`) VALUES ('invitation.poundage','40');
INSERT INTO `conf` (`key`,`value`) VALUES ('rent.poundage','0');
INSERT INTO `conf` (`key`,`value`) VALUES ('indent.refund.percentage.less1hour','25');
INSERT INTO `conf` (`key`,`value`) VALUES ('indent.refund.percentage.1to3hour','30');
INSERT INTO `conf` (`key`,`value`) VALUES ('indent.refund.percentage.greater3hour','40');
